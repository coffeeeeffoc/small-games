...
The expansion library (7 scenes, 10 vehicles, 10 drivers and 12 items) lives exclusively in [`assets/carding-car/expansion`](../../../../assets/carding-car/expansion/README.md). Its source models, concepts, textures, previews and generation scripts are versioned in that asset repository. Run `python assets/carding-car/expansion/check-assets.py --complete` from the small-games root to validate it. Expansion art is not part of the current runtime export.
