...
type Choice = LegacyCultivationContent['events'][number]['choices'][number];
import type { LegacyCultivationContent } from './legacy.js';
...
/** Historical v2 campaign fixture for validating compatibility with published content. */
export const legacyCultivationContent: LegacyCultivationContent = {
  title: '三分钟修仙',
  chapters: [
...
export const legacyCultivationEnvelope: DynamicContentEnvelope<LegacyCultivationContent> = {
  gameId: 'cultivation',
  schemaVersion: 2,
  revision: 1,
  payload: legacyCultivationContent,
};
